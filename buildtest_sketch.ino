...
Developer: Gunjan Patel (BMSWGNP)
You can test www.google.com as test ping with build test program
...
/**************************************************************************/
/*!
       @ Before you run the sketch, edit it to replace 
       @ the dummy SSID and password with your own
*/
/**************************************************************************/


#define WLAN_SSID       "yournetwork_SSID"        // cannot be longer than 32 characters!
#define WLAN_PASS       "yournetwork_PASS"
...
/*!
    ...
    @ Make sure you selected "Baud Rate : 115200"
*/
/**************************************************************************/
void setup(void)
{
...
/*
  uint8_t macAddress[6] = { 0x02, 0x08, 0xB8, 0x21, 0x33, 0xA7 };
...
*/
  ...
  */
  /* Optional: Revert back from static IP address to use DHCP.
